const ThankYou = () => {
  return (
    <div className="flex flex-col items-center space-y-4 rounded-md bg-white p-6 shadow-md">
      <svg
      ...
      <h1 className="text-4xl font-bold text-primary-marineBlue">Thank You!</h1>
